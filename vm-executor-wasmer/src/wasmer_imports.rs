...
#[rustfmt::skip]
fn wasmer_import_managed_drwanative_governance_query(env: &VMHooksWrapper, query_type: i32, key_handle: i32, dest_handle: i32) -> i32 {
    env.vm_hooks.managed_drwanative_governance_query(query_type, key_handle, dest_handle)
}
...
pub fn generate_import_object(store: &Store, env: &VMHooksWrapper) -> ImportObject {
    imports! {
        "env" => {
            ...
            "managedDRWANativeGovernanceQuery" => Function::new_native_with_env(store, env.clone(), wasmer_import_managed_drwanative_governance_query),
