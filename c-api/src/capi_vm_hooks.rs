...
impl multiversx_chain_vm_executor::VMHooksLegacy for CapiVMHooks {
    ...
    fn managed_drwanative_governance_query(&self, query_type: i32, key_handle: i32, dest_handle: i32) -> i32 {
        (self.c_func_pointers_ptr.managed_drwanative_governance_query_func_ptr)(self.vm_hooks_ptr, query_type, key_handle, dest_handle)
    }
