...
#[rustfmt::skip]
fn wasmer_import_managed_drwanative_governance_query(env: FunctionEnvMut<VMHooksWrapper>, query_type: i32, key_handle: i32, dest_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_drwanative_governance_query(query_type, key_handle, dest_handle))
}
...
pub fn generate_import_object(store: &mut Store, vh_wrapper: VMHooksWrapper) -> Imports {
    ...
    imports! {
        "env" => {
            ...
            "managedDRWANativeGovernanceQuery" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_drwanative_governance_query),
