...
pub trait VMHooks: core::fmt::Debug {
    ...
    fn managed_drwanative_governance_query(&mut self, query_type: i32, key_handle: i32, dest_handle: i32) -> Result<i32, VMHooksEarlyExit>;
...
impl VMHooks for VMHooksDefault {
    ...
    fn managed_drwanative_governance_query(&mut self, query_type: i32, key_handle: i32, dest_handle: i32) -> Result<i32, VMHooksEarlyExit> {
        println!("Called: managed_drwanative_governance_query");
        Ok(0)
    }
